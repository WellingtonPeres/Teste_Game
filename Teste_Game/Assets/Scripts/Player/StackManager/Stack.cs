...
public class Stack : MonoBehaviour
{
    ...
    public void MoveListElements()// Transformar em um único método com o MoveListElements() -> A baixo
    {
        ...
        for (int i = 1; i < stackEnemies.Count; i++)
        {
            ...
            position = stackEnemies[i - 1].transform.localPosition;// Mudar cubes[i - 1] para parametro em um métodos único
    ...
    public void MoveListOrigin()// Transformar em um único método com o MoveListElements() -> A cima
    {
        float distanceCubes = 0.4f;//
        Vector3 newDistanceCubes = new Vector3(0, distanceCubes, 0);//
